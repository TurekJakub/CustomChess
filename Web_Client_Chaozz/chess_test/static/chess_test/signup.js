...
function changeDisplayedImage() {
    ...
    if (!init) {
        document.getElementById('cropper-container').style.setProperty('width', 'calc(100vw * 3/16 -5)')
...
function makeSignUpRequest() {
    ...
    profilePicture = new File([image], $('#username-input').val() + '_picture.jpge', { type: "image/jpeg" });
